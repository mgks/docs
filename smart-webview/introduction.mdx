---
title: 'Introduction'
description: 'Overview of the Smart WebView project.'
icon: 'wave'
---

import { Tab, Tabs, Card } from 'mintlify/components';
...
<Card horizontal title="Smart WebView on GitHub" icon="github" href="https://github.com/mgks/Android-SmartWebView/" target="_blank">
</Card>
